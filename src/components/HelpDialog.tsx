      ...
      <div className="flex flex-col h-full max-h-[90vh]">
        ...
        <div className="space-y-4 overflow-y-auto flex-1 px-5 py-4 pr-4" style={{ scrollbarWidth: "thin" }}>
          ...
          <section>
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Мы доставляем заказы в выбранное время после подтверждения. Доступны самовывоз и доставка курьером.
            </p>
            <ul className="mt-2 text-sm text-muted-foreground space-y-1 list-disc pl-4">
              <li>Укажите точный адрес доставки при оформлении заказа</li>
              <li>Время доставки выбирается администратором при принятии заказа (13:00-14:00, 14:00-15:00, 15:00-16:00, 16:00-17:00)</li>
              <li>Если нужна доставка в другое время — укажите это в комментарии при оформлении заказа</li>
              <li><strong>Стоимость доставки: 1000 ₸</strong> — автоматически добавляется к сумме заказа</li>
              <li>Вы получите уведомление с точным временем доставки после принятия заказа</li>
            </ul>
            <p className="mt-2 text-sm text-muted-foreground">
              Итоговая сумма заказа включает стоимость всех товаров плюс доставку 1000 ₸. Вы увидите разбивку при оформлении заказа.
            </p>
          </section>
            ...
            <div className="mt-2 space-y-3">
              <div className="text-sm">
                ...
                <p className="text-muted-foreground">
                  Заказ принят в работу. В уведомлении вы увидите точное время доставки (например, 13:00-14:00). Мы начнём готовить ваш заказ и доставим его в указанное время.
                </p>
              </div>
              <div className="text-sm">
