        ...
        <div className="space-y-6">
          <section>
            ...
            <ol className="mt-2 text-sm text-muted-foreground space-y-2 list-decimal pl-5">
              ...
              <li>При принятии заказа выберите время доставки из доступных слотов (13:00-14:00, 14:00-15:00, 15:00-16:00, 16:00-17:00)</li>
              <li>Нажмите «✅ Принят» в Telegram и выберите время доставки, или используйте админ-панель для изменения статуса и времени</li>
              <li>Клиент получит уведомление с выбранным временем доставки</li>
              <li>Используйте фильтры по статусу для быстрого поиска нужных заказов</li>
            </ol>
            <p className="mt-2 text-sm text-muted-foreground">
              В уведомлении о новом заказе в Telegram есть кнопка «✅ Принят» — нажмите её, и вам будет предложено выбрать время доставки. 
              Для отказа используйте кнопку «❌ Отказано» или откройте заказ в админ-панели для указания причины.
            </p>
            <p className="mt-2 text-sm text-muted-foreground">
              <strong>Важно:</strong> Стоимость доставки 1000 ₸ автоматически добавляется к сумме заказа. В уведомлениях и в админ-панели вы увидите разбивку: сумма товаров + доставка = итоговая сумма.
            </p>
          </section>
            ...
            <div className="mt-2 space-y-3">
              <div className="text-sm">
                ...
                <p className="text-muted-foreground">
                  После проверки оплаты и чека переключите заказ в «Принят» и выберите время доставки (13:00-14:00, 14:00-15:00, 15:00-16:00, 16:00-17:00). 
                  Клиент получит уведомление с точным временем доставки. Начните готовить заказ и доставьте его в указанное время.
                </p>
                <p className="text-muted-foreground mt-1">
                  <strong>Изменение времени:</strong> Вы можете изменить время доставки для принятого заказа, нажав кнопку «Изменить время доставки» в деталях заказа.
                </p>
              </div>
              <div className="text-sm">
